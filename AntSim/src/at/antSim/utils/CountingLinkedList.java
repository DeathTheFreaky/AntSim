...
/**
 * Used to store objects as long as they are being "updated" by increasing their
 * internal update count.<br>
 * When an object is no more updated (when their internal update count reaches
 * 0), it is deleted from the list.
 * 
 * @author Flo
 *
 * @param <E>
...
public class CountingLinkedList<E> {
	...
	/**
	 * @param key
	 * @return - true, if the passed key is stored inside this
	 *         {@link CountingLinkedList}
	 */
	...
	/**
	 * Increases an Element's "life" count, so it won't be deleted on the next
	 * update cycle.
	 * 
	 * @param key
	 */
	...
	/**
	 * @return - a LinkedList of all Elements which have not been increased and
	 *         hence are no more part of this {@link CountingLinkedList}
	 */
	...
	/**
	 * @return - an UnmodifiableList of all Elements stored by this
	 *         {@link CountingLinkedList}
	 */
