...
public class EngineTester {
	...
	GuiState startMenu;
	GuiState optionsDisplay;
	GuiState optionsControls;
	GuiState mainGame;
	GuiState loadingState;
	 ...
	 * @param renderer
	 */
	private void loadGui(Loader loader, MasterRenderer renderer) {
		...
		//MEINS
		startMenu = new GuiState("startMenu");
		optionsDisplay = new GuiState("optionsDisplay");
		optionsControls = new GuiState("optionsControl");
		mainGame = new GuiState("mainGame");
		loadingState = new GuiState("loadingState");
	...
	private void loadWorld(Loader loader, MasterRenderer renderer) {
		...
		if (!worldLoaded) {
			...
			entities = new ArrayList<Entity>(); //holds all entities to be rendered
			...
			GuiWrapper.getInstance().setCurrentState(mainGame.getName());
		}
	}
