...
uniform vec3 fogColor; //lower section of skybox shall fade into the fog
...
void main(void){
    ...
    out_Color = mix(vec4(fogColor, 1.0), finalColor, factor); //calculate color of final pixel onscreen
}
